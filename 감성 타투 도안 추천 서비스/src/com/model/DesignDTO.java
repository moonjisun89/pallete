...
public class DesignDTO {
	...
	//전체
	public DesignDTO(String shop_num, String shop_name, String shop_content, String shop_likes, String shop_addr,
			String shop_tel, String shop_time, String shop_kinds, String shop_url, String shop_img1, String shop_img2,
			String shop_img3, String shop_img4, String shop_img5, String shop_id, String kinds_id) {
		super();
	...
	public DesignDTO(String shop_num, String shop_name, String shop_content, String shop_likes, String shop_addr,
			String shop_kinds, String shop_img1) {
		this.shop_num = shop_num;
		this.shop_name = shop_name;
		this.shop_content = shop_content;
		this.shop_likes = shop_likes;
	...
	public DesignDTO(String shop_num, String shop_name, String shop_content, String shop_addr, String shop_tel,
	...
	public DesignDTO(String shop_num, String shop_name, String shop_content, String shop_likes, String shop_addr,
			String shop_kinds, String shop_img1, String shop_img2, String shop_id) {
		this.shop_num = shop_num;
		this.shop_name = shop_name;
		this.shop_content = shop_content;
		this.shop_likes = shop_likes;
	...
	public DesignDTO(String shop_name, String shop_content, String shop_addr, String shop_tel, String shop_time,
			String shop_kinds) {
		this.shop_name = shop_name;
		this.shop_content = shop_content;
		this.shop_addr = shop_addr;
